...
export default function LandingHero() {
  ...
  return (
    <section className="relative flex min-h-[620px] items-center justify-center overflow-hidden border-b-8 border-[#232323] px-4 pb-12 pt-24 text-white sm:min-h-[680px] sm:px-6 lg:min-h-[720px]">
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage:
      ...
      <div className="relative z-10 mx-auto w-full max-w-[760px] text-center">
        ...
        >
          <input
            ...
            placeholder="Email address"
            required
            className="h-14 flex-1 rounded border border-white/60 bg-black/45 px-4 text-base text-white outline-none placeholder:text-[#b3b3b3] focus:border-white"
          />

          <button
            type="submit"
            className="h-14 rounded bg-[#e50914] px-7 text-lg font-bold text-white transition-colors hover:bg-[#f6121d] sm:text-xl"
          >
            Get Started &gt;
          </button>
        </form>
