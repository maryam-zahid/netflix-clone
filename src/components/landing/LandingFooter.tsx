...
//   return (
// <footer className="bg-black px-4 py-12 text-[#b3b3b3] sm:px-6 lg:px-8">      <div className="mx-auto w-full max-w-[1000px]">
...
export default function LandingFooter() {
  return (
    <footer className="bg-black px-4 py-12 text-[#b3b3b3] sm:px-6 lg:px-8">
